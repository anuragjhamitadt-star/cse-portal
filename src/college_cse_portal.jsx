...
// ════════════════════════════════════════════════════════
function AdminCollaborations({collabs,setCollabs}) {
...
//  TICKET ADMIN PORTAL
// ════════════════════════════════════════════════════════
function TicketAdminPortal({ticketEvents,setTicketEvents,registrations,setRegistrations,eventArchive,setEventArchive}) {
...
function AdminDashboard({resources,setResources,faculty,setFaculty,ticketEvents,setTicketEvents,registrations,setRegistrations,creds,setCreds,adminRole,onLogout,eventArchive,setEventArchive,collabs,setCollabs}) {
  ...
  return (
    <div>
      ...
      {tab==="tickets"&&<TicketAdminPortal ticketEvents={ticketEvents} setTicketEvents={setTicketEvents} registrations={registrations} setRegistrations={setRegistrations} eventArchive={eventArchive} setEventArchive={setEventArchive}/>}
      {tab==="collabs"&&<AdminCollaborations collabs={collabs} setCollabs={setCollabs}/>}
