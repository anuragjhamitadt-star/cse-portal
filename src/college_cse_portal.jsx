...
export default function App() {
  ...
  const setResources=useCallback(updater=>{
    setResourcesLocal(prev=>{
      ...
      if(dbReadyRef.current) setDoc(doc(db,"portal","resources"),next).catch(console.error);
      return next;
    });
  },[]);
  ...
  const setCreds=useCallback(updater=>{
    setCredsLocal(prev=>{
      ...
      if(dbReadyRef.current) setDoc(doc(db,"portal","creds"),next).catch(console.error);
      return next;
    });
  },[]);
